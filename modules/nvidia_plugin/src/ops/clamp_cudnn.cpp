...
ClampCuDnnOp::ClampCuDnnOp(const CreationContext& context,
    ...
    : OperationCuDnn{context, node, move(inputIds), move(outputIds)},
      ...
      max_op_desc_{CUDA::DnnOpTensorDescriptor{}.set(CUDNN_OP_TENSOR_MAX, op_type_, CUDNN_NOT_PROPAGATE_NAN)},
      min_op_desc_{CUDA::DnnOpTensorDescriptor{}.set(CUDNN_OP_TENSOR_MIN, op_type_, CUDNN_NOT_PROPAGATE_NAN)},
