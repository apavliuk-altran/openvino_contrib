...
struct ITopologyRunner {
    ...
    // virtual void Run(InferenceRequestContext& context, const Workbuffers& workbuffers, ICudaGraphInfo& graphContext) const = 0;
    // virtual void Capture(InferenceRequestContext& context, const Workbuffers& workbuffers, ICudaGraphInfo& graphContext) const = 0;
};
