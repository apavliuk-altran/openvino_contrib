...
public: 
    ...
    virtual void add_new_graph_info() = 0;

    virtual const ICudaGraphInfo& get_current_graph_info() const = 0;
    virtual ICudaGraphInfo& get_current_graph_info() = 0;
...
public:
    ...
    void add_new_graph_info() override {}

    const ICudaGraphInfo& get_current_graph_info() const override { return *this; }
    ICudaGraphInfo& get_current_graph_info() override { return *this; }
...
public:
    ...
    const ICudaGraphInfo& get_current_graph_info() const override;
    ICudaGraphInfo& get_current_graph_info() override;
